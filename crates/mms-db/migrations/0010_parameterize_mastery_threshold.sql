-- Migration: Parameterize the mastery threshold in refresh_deck_progress
-- Instead of hardcoding `10` as the max points per card, accept it as a parameter.
-- This keeps the Rust crate (mms-srs) as the single source of truth for MASTERY_THRESHOLD.
